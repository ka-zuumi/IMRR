...
$FC -free DOUBLE_v.o PARAMETERS_v.o VARIABLES_v.o FUNCTIONS_v.o ANALYSIS_v.o ls_rmsd_original_v.o SIMILARITY_v.o interactMultipleGrids_v.o main.f90 -o main.o
